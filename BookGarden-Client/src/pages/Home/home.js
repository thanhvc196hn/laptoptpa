      ...
      >
        ...
        >
          <Carousel autoplay dots={false}>
            <div className="w-full h-96">
              <img
                src="https://cdnv2.tgdd.vn/mwg-static/tgdd/Banner/ea/9f/ea9f9e9c4ed53c1e476fc0715ad248e5.jpg"
                alt="slide 1"
            ...
            <div className="w-full h-96">
              <img
                src="https://cdnv2.tgdd.vn/mwg-static/tgdd/Banner/4c/cc/4cccf5d4e0310dbd54647cf5e193bb33.png"
                alt="slide 2"
                className="object-cover w-full h-full"
              />
            </div>
            <div className="w-full h-96">
              <img
                src="https://cdnv2.tgdd.vn/mwg-static/tgdd/Banner/fe/2b/fe2bdbb4955e6fd0b3b9a20ec23ea8b8.png"
                alt="slide 3"
                className="object-cover w-full h-full"
              />
            </div>
        ...
        <div className="image-one">
          ...
          <div className="texty-title">
            <p>
              Máy tính <strong style={{ color: "#FF0000" }}>Hàng mới</strong>
            </p>
          </div>

          <div className="container list-products" key="1">
            <Row
        ...
        <div className="image-one">
          ...
          <div className="texty-title">
            <p>
              Máy tính <strong style={{ color: "#FF0000" }}>Bán Chạy</strong>
            </p>
          </div>
