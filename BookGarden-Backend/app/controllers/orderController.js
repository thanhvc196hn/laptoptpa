...
const orderController = {
  ...
  createOrder: async (req, res) => {
    ...
    `;
      ...
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f4f4f4; padding: 20px; border-radius: 8px; max-width: 700px; margin: auto; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
        <h2 style="color: #20c997; font-size: 24px; font-weight: bold; text-align: center; margin-bottom: 20px;">Cảm ơn bạn đã đặt hàng tại Công Thành !</h2>
        ...
        <div style="margin-top: 20px; padding: 15px; background-color: #eafaf1; border-radius: 8px; text-align: center;">
          <p style="font-size: 16px; margin: 0;">Cảm ơn bạn đã tin tưởng mua sắm tại <strong>Công Thành</strong>!</p>
        ...
        <footer style="margin-top: 30px; text-align: center; font-size: 14px; color: #555;">
          <p style="margin: 5px 0;">Công Thành - Cửa hàng điện thoại yêu thương</p>
          <p style="margin: 5px 0;">Hotline: 1900 123 456 | Email: congthanh@gmail.com</p>
        </footer>
      </div>
    `;
  ...
  <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f4f4f4; padding: 20px; border-radius: 8px; max-width: 700px; margin: auto; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    ...
    <div style="margin-top: 20px; padding: 15px; background-color: #eafaf1; border-radius: 8px; text-align: center;">
      <p style="font-size: 16px; margin: 0;">Cảm ơn bạn đã sử dụng dịch vụ của <strong>Công Thành</strong>!</p>
      <p style="font-size: 16px; font-weight: bold; margin: 5px 0;">Chúc bạn một ngày tuyệt vời!</p>
    </div>

    <footer style="margin-top: 30px; text-align: center; font-size: 14px; color: #555;">
      <p style="margin: 5px 0;">Công Thành - Cửa hàng yêu thương</p>
      <p style="margin: 5px 0;">Hotline: 1900 123 456 | Email: congthanh@gmail.com</p>
    </footer>
  </div>
      `;
